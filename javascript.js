...
function openDb(){
	db = openDatabase("QueueList", "1", "Queue List", 1024*1024);
...
function renderItems(tx , rs){
	...
	for(i=0; i<rs.rows.length; i++){
		...
		output += "<ons-list-item>" + row.item + "<div class = \"right\"><ons-button onClick = 'deleteItem(" + row.ID + ");')><ons-icon icon=\"trash\"></ons-icon></ons-buutton></div>" + "</ons-list-item>";
	}
